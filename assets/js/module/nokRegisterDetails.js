...
var aadhar_card_photo_h = document.getElementById('aadhar_card_photo_h');
...
$("#aadhar_card_photo").click(function () {
    checkIt('aadhar_card_photo', aadhar_card_photo_h);
});
...
$("#personnel_no").on("change", function () {
    ...
    if (personnel_no_value.length == 1) {
        ...
        $.ajax({
            url: DOMAIN + 'user_details/NOKRegister/checkRetireeData',
            method: 'POST',
            ...
            success: function (response) {
                ...
                if (status === 'success') {
                    if (result.length > 0) {
                        ...
                        $("#date_of_birth").val(result[0].date_of_birth).prop('disabled', true);
                        ...
                        // $("#email_id").val(result[1].email_id);
                        // $("#mobile_no").val(result[1].mobile_no);
                        // $("#aadhar_card_no").val(result[1].adhaar_card);
                        // $("#address").val(result[0].permanent_address);
                        // $("#rank").val(result[0].rank);
                        // $("#nok_name").val(result[1].nok_name);
                        // $("#relationship").val(result[0].nok_name);
                        ...
                        //     var IMAGE_UPLOAD_PATH = "http://localhost/bsf_clms/CLMS/";
                        //     var aadhar_card_photo = IMAGE_UPLOAD_PATH + result[0].ppo_photo;
                        //     console.log("photo", aadhar_card_photo);
                        //     var photo_name = aadhar_card_photo.substring(aadhar_card_photo.lastIndexOf("/") + 1, aadhar_card_photo.length);
                        //     console.log(photo_name);

                        //     // var ppo_photo_path = IMAGE_UPLOAD_PATH + result[0].ppo_photo;
                        //     // console.log("photo path", ppo_photo_path);
                        //     $("#aadhar_card_photo_img").attr('src', aadhar_card_photo);
                        //     $("#aadhar_card_photo_label").text(photo_name);
                        //     // $("#aadhar_card_photo").val(photo_name);
                        // } else {
                        //     $("#aadhar_card_photo_img").val('');
                        // }

                        // if (result[0].user_photo !== '' && result[0].user_photo !== 'null' && result[0].user_photo !== null) {
                        //     var IMAGE_UPLOAD_PATH = "http://localhost/bsf_clms/CLMS/";
                        //     var user_photo = IMAGE_UPLOAD_PATH + result[0].user_photo;
                        //     // console.log("photo", user_photo);
                        //     var photo_name = user_photo.substring(user_photo.lastIndexOf("/") + 1, user_photo.length);
                        //     // console.log(photo_name);

                        //     // var ppo_photo_path = IMAGE_UPLOAD_PATH + result[0].ppo_photo;
                        //     // console.log("photo path", ppo_photo_path);
                        //     $("#personnel_photo_img").attr('src', user_photo);
                        //     $("#personnel_photo_label").html(photo_name);
                        //     // $("#personnel_photo").val(photo_name);
                        // } else {
                        //     $("#personnel_photo").val('');
                        // }
                        ...
                        //     var IMAGE_UPLOAD_PATH = "http://localhost/bsf_clms/CLMS/";
                        //     var card_photo = IMAGE_UPLOAD_PATH + result[0].card_photo;
                        //     // console.log("photo", card_photo);
                        //     var photo_name = card_photo.substring(card_photo.lastIndexOf("/") + 1, card_photo.length);
                        //     // console.log(photo_name);

                        //     // var ppo_photo_path = IMAGE_UPLOAD_PATH + result[0].ppo_photo;
                        //     // console.log("photo path", ppo_photo_path);
                        //     $("#id_card_photo_img").attr('src', card_photo);
                        //     $("#id_card_photo_label").html(photo_name);
                        //     // $("#id_card_photo").val(photo_name);
                        // } else {
                        //     $("#id_card_photo").val('');
                        // }
                        ...
                        //     var IMAGE_UPLOAD_PATH = "http://localhost/bsf_clms/CLMS/";
                        //     var signed_photo = IMAGE_UPLOAD_PATH + result[0].signed_photo;
                        //     // console.log("photo", signed_photo);
                        //     var photo_name = signed_photo.substring(card_photo.lastIndexOf("/") + 1, card_photo.length);
                        //     // console.log(photo_name);

                        //     // var ppo_photo_path = IMAGE_UPLOAD_PATH + result[0].ppo_photo;
                        //     // console.log("photo path", ppo_photo_path);
                        //     $("#signed_form_photo_img").attr('src', card_photo);
                        //     $("#signed_form_photo_label").html(photo_name);
                        //     // $("#signed_form_photo").val(photo_name);
                        // } else {
                        ...
                        // $("#relationship").val(result[1].relationship_type).trigger('change').prop('disabled', false);
...
$(function () {
    ...
    $.ajax({
        url: DOMAIN + 'user_details/NOKRegister/fetchRetireeInitialFormDetails',
        method: 'POST',
        data: {
            csrf_test_name: csrfHash
        },
        success: function (response) {
            ...
            var relationship_select = result['relationship_select_option_array'];

            var posting_unit_html = '<option></option>';
            var force_select_html = '<option></option>';
            var relationship_select_html = '<option></option>';
            ...
            for (var i = 0; i < relationship_select.length; i++) {
                relationship_select_html += `<option value="${relationship_select[i].relationship_type}">${relationship_select[i].relationship_type}</option>`;
            }

            $("#force_type").html(force_select_html);
            $("#posting_unit_type").html(posting_unit_html);
            $("#replationship").html(relationship_select_html);
    ...
    $("#relationship").select2({ width: '100%', placeholder: 'Select a relationship' });
    ...
    $("#personnel_no").select2({
        ...
        allowClear: true,
        ajax: {
            url: DOMAIN + 'user_details/NOKRegister/fetchRetireeDetails',
            dataType: 'json',
            delay: 250,
            method: 'POST',
    ...
    $("#register_retiree").click(function (event) {
        ...
        var nok_name_valiadtion = checkInputEmpty("nok_name", "Kindly enter a NOK name");
        ...
        var relationship = checkInputEmpty("relationship", "Kindly select a relationship");
        ...
        var aadhar_card_photo_valiadtion = checkInputEmpty("personnel_photo", "Kindly select personnel photo");
        var ppo_photo_valiadtion = checkInputEmpty("aadhar_card_photo", "Kindly select Aadhar Card photo");
        ...
        address_valiation = checkValidInput("address", "Kindly enter valid address", address_regex_pattern);

        var date_of_birth_validation_func = validateDateOfBirth();

        // console.log('personnel',personnel_no_valiadtion);
        ...
        if (personnel_no_valiadtion || aadhar_card_no_valiadtion || retiree_name_valiadtion || nok_name_valiadtion || mobile_no_valiadtion || email_id_valiadtion || date_of_birth_valiadtion || posting_unit_type_valiadtion || rank_valiadtion || force_type_valiadtion || relationship) {
...
//     var ppo_photo_name = ppo_photo.substring(ppo_photo.lastIndexOf("\\") + 1, ppo_photo.length);
...
function loadData() {
    ...
    var aadhar_card_photo = $("#aadhar_card_photo")[0].files[0];
    ...
    formData.append('aadhar_card_photo', aadhar_card_photo);
    ...
    // }
    $.ajax({
        url: DOMAIN + 'user_details/NOKRegister/addNOK',
        method: 'POST',
        data: formData,
        // dataType: 'JSON',
        contentType: false,
...
function updateDatabase() {
    ...
    $.ajax({
        url: DOMAIN + 'user_details/NOKRegister/updateNOK',
        method: 'POST',
        data: formData,
        processData: false,
        contentType: false,
