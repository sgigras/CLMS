$(document).ready(function () {
  ...
  $("#base_price").change(function () {
    ...
    // $("#sell_price_display").text(sell_price);
    // $("#liquor_display_purchase").text(purchase_price);
    // $("#liquor_display_sell").text(sell_price);
  });
  ...
  //   var profit = 0;
  //   if (!checkInputEmpty("sell_price", "kindly enter a sell price")) {
  //     // if(sell_price!==)
  //     if (sell_price !== "" && purchase_price !== "") {
  //       displayProfit(sell_price, purchase_price)
  //     }
  //   }
  ...
  //     return result.toFixed(2);
  //   } else {
  //     var result = parseFloat(price) + absolute;
  //     return result.toFixed(2);
  //   }
  ...
  function displayProfit(sell_price, purchase_price) {
    ...
    // if (price >= 500.00) {
    //   profit = 3.00;
    // } else if (price >= 100.00 && price <= 499.00) {
    //   profit = 2.00;
    // } else {
    //   profit = 1.00;
    // }
    // console.log(parseFloat(profit).toFixed(2));
    // console.log(price)
    // sell_price = parseFloat(price) + parseFloat(profit);
    $("#profit").text(profit);
  ...
  $("#liquor_mapping_details").click(function (event) {
    ...
    checkInputEmpty("moq", "kindly enter a lot size");
    // checkInputEmpty("sell_price", "kindly enter a sell price");
