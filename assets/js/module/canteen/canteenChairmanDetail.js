$(document).ready(function () {
    ...
    $("#select_chairman").prop("disabled", true);
    ...
    $("#select_distrubuting_authority").change(function () {  //on selection of distrubition authority fetching the respective distributor
        ...
        $("#select_distributor_name").val('').trigger('change');
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if(distrubtor_authority=== 1){
                    $("#select_distributor_name").attr("multiple","multiple");
                    $("#select_distributor_name").attr("name","select_distributor_name[]");
                }else{
                    $("#select_distributor_name").removeAttr("multiple");
                    $("#select_distributor_name").attr("name","select_distributor_name");
                }
    ...
    $("#select_supervisor").change(function () {
        checkInputEmpty("select_supervisor", "Kindly select a aupervisor");
    ...
    //        canteenDetailsObj.distributor_name = $("#select_distributor_name").val().trim();
