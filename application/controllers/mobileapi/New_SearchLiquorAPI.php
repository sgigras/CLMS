...
class New_SearchLiquorAPI extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('Cart_details/New_Cart_model', 'cart_model');
        $this->load->model('Order/New_Stockist_order_model', 'stockist_order_model');
        $this->load->model('Order_details/New_Order_model', 'order_model');
    ...
    public function addToCart()
    {
        ...
        $total_cost_size = (int)$product_quantity * floatval($product_price);
        $cart_data = array(
            'action' => 'ADD',
    ...
    public function cancelOrder()
    {
        ...
        // echo json_encode($data);
        $response = $this->cart_model->cancelOrder(json_encode($data));
        echo json_encode($response);
    }

    public function add_remove_liquor()
    {
        $cart_data = json_decode(file_get_contents('php://input'));
        $response = $this->cart_model->add_remove_liquor(json_encode($cart_data));
        echo json_encode($response);
    }
}
