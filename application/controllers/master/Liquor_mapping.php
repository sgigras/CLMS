...
class Liquor_mapping extends MY_Controller
{
    ...
    public function getLiquorTaxForSellingPrice()
    {
        ...
        // $tax_category = $this->input->post('tax_category');,$tax_type_id,$tax_category,
        $entity_id = $this->session->userdata('entity_id');
    ...
    public function addLiquorMappingDetails()
    {
        ...
        if ($this->input->post('submit')) {
            ...
            $data = array(
                ...
                'purchase_price' => $this->input->post('hid_purchase_price'),
                'user_id' => $this->session->userdata('admin_id'),
    ...
    public function CheckEntityMasterForm()
    {
        ...
        $this->form_validation->set_rules('hid_purchase_price', 'Purchase Price', 'trim|required');
