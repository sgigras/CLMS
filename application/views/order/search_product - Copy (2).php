                                    ...
                                    <div class="row">
                                        <div class="col-12" style="padding: 0px!important;">
                                            <?php if ($cart_type == 'consumer') {
                                                ...
                                                $this->load->view('master/select_field', array("field_id" => "select_state", "label" => "", "place_holder" => "Select a state", "option_record" => $state_select_array, "option_value" => "id", "option_text" => "state", "selected_value" => ''));
                                            } ?>
                                        </div>
                                    </div>
                                    <div class="row">
...
<script>
    ...
    function fetch_products(keyword) {
        ...
        if (trigger_consumer_auto_select_change) {
