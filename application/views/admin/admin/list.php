<div class="datalist">
    ...
    <table id="example1" class="table datatable datatable-bordered table-bordered datatable-striped">
        <thead>
            <tr>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="<?= base_url("admin/admin/edit/".$row['admin_id']); ?>" title="Edit" class="btn btn-warning btn-xs mr5" >
