           ...
           <!-- For Messages -->
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                  <select name="role" class="form-control">
                    ...
                    <?php foreach($admin_roles as $role): ?>
                      <?php if($role['ID'] == $admin['ID']): ?>
                        <option value="<?= $role['ID']; ?>" selected><?= $role['admin_role_title']; ?></option>
                        <?php else: ?>
              ...
              <div class="form-group">
                ...
                <div class="col-md-12">
                  <input type="text" name="username" onkeypress="return /[A-Za-z ]/i.test(event.key)" maxlength="30" value="<?= $admin['username']; ?>" class="form-control" id="username" placeholder="">
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-md-12">
                  <input type="text" name="firstname" onkeypress="return /[A-Za-z ]/i.test(event.key)" maxlength="30" value="<?= $admin['firstname']; ?>" class="form-control" id="firstname" placeholder="">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-12">
                  <input type="text" name="lastname" onkeypress="return /[A-Za-z ]/i.test(event.key)" maxlength="30" value="<?= $admin['lastname']; ?>" class="form-control" id="lastname" placeholder="">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-12">
                  <input type="email" name="email" maxlength="30" value="<?= $admin['email']; ?>" class="form-control" id="email" placeholder="">
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-md-12">
                  <input type="text" name="mobile_no" onkeypress="return /[0-9]/i.test(event.key)"  maxlength="10" value="<?= $admin['mobile_no']; ?>" class="form-control" id="mobile_no" placeholder="">
                </div>
              </div>
              <div class="form-group">
