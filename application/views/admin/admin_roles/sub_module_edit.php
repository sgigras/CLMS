...
<section class="content">
    <div class="card card-default">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                <label for="mobile_link" class="col-md-2 control-label">Mobile Link</label>

                <div class="col-md-12">
                    <input type="text" name="mobile_link" class="form-control" value="<?= $module['mobile_link']; ?>" id="mobile_link" placeholder="eg. filename.html">
                </div>
            </div>
            <div class="form-group">
