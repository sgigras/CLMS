		...
		<div class="card">
			<div class="card-header">
				...
				<div class="d-inline-block float-right">
					<a href="<?= base_url('admin/admin_roles/module_add'); ?>" class="btn btn-secondary"><i class="fa fa-plus"></i> <?= trans('add_new_module') ?></a>
				</div>
			</div>

			<div class="card-body">
				    <div class="card-body table-responsive">
				<table id="example1" class="table datatable datatable-bordered table-bordered datatable-striped" width="100%">
					<thead class="m0 mb5">
						<tr>
