                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="admin_role_title" value="<?=isset($record['admin_role_title'])?$record['admin_role_title']:''?>" required="" onkeypress="return checkValidInputKeyPress(alphabet_space_regex_pattern);">
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
