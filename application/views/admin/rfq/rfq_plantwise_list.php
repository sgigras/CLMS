                ...
                <div class="box">
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      <div class="row">
                         <div class="col-md-4">
                         <img src="<?=base_url('./assets/plugins/icons/Request_verification.png')?>" class="" alt="" width="50px" height="50px">&nbsp;<label>Rfq Sent to Corporate For Verification</label>
                          </div>
                          <div class="col-md-3">
                        <img src="<?=base_url('./assets/plugins/icons/Verified.png')?>" class="" alt="" width="50px" height="50px">&nbsp;<label>Rfq Verified by Corporate</label>
                      </div>
                      <div class="col-md-5">
                          ...
                          <tbody>
                            ...
                            <?php foreach($rfq as $row): ?>
                              ...
                              <td class="text-center" width="10%">
                                <?php $icon= (($row['rfq_status'] == 0)? './assets/plugins/icons/Request_verification.png': (($row['rfq_status'] == 1)? './assets/plugins/icons/Verified.png': (($row['rfq_status'] == 2)? './assets/plugins/icons/vendor_det.png': 'None')));?>
                                <img src="<?=base_url($icon)?>" class="" alt="" width="70%" height="50%">
                              </td>


                              <td class="text-center">
                               <a title="View" id="change" class="view btn btn-sm btn-info" href="<?= base_url("rfq/RequestquotationAPI/plantwise_view/".$row['id']) ?>"> <i class="fa fa-eye"></i></a>
                             </td>
