<table class="table table-hover small-text" id="tb2">
    <thead>
        <tr class="tr-header">
            ...
            <th style="width:150px;">Base Price/Bottle</th>
            <th style="width:150px;">Quantity In Bottle</th>
...
<script>
    $(function() {
        ...
        $("#liquor_details_body").append('<tr id="A1">' +
            ...
            '<select name="liquor_name" class="form-control liquor_select" id="liquor_name1">' +
            ...
            '<input type="text" maxlength="5" onkeypress="return checkValidInputKeyPress(numeric_regex_pattern)" placeholder="Enter Price" name="selling_price" id="selling_price1" class="form-control">' +
            '</td>' +
            '<td style="width:150px">' +
        ...
        $(document).on("click", ".addmorerows", function(event) {
            ...
            $("#tb2").append('<tr id="A' + rowCounter + '">' +
                '<td>&nbsp;</td>' +
                '<td style="width:200px;"><select class="form-control" id="liquor_name' + rowCounter + '">' +
                '<option value="" selected="" disabled="">Select Liquor</option>' +
                "<?php
                    foreach ($liquor_name_record as $liquor) {
                        echo '<option value=' . $liquor->id . '>' . $liquor->liquor .  '</option>';
                    ...
                    ?>" +
                '</select></td>' +
                '<td  style="width:100px"><input type="text" name="selling_price" id="selling_price' + rowCounter + '" class="form-control"></td>' +
                ...
                '<td style="width:100px"><input type="text" name="total" id="total' + rowCounter + '"class="form-control" placeholder="Total" disabled> </td>' +
