    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="d-inline-block float-right">
                <a href="orderToBrewery" class="btn btn-secondary"><i class="fa fa-plus"></i>Add Order</a>
            </div>
        </div>
        <br>
        <div class="card-body">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <?php if ($row["approval_status"]=="P"){?>
                            <td><a href="printBreweryOrder?order_id=<?php echo $row["brewery_order_code"]?>">Approve/Reject</a></td>
                        <?php } elseif ($row["approval_status"]=="R") {?>
                            <td><a href="printBreweryOrder?order_id=<?php echo $row["brewery_order_code"]?>">Reject</a></td>
                        <?php } else {?>
