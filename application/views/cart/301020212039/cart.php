            ...
            <div class="form-group">
                <div class=row>
                    ...
                    <div class="col-md-8" style="margin-left: 50vw;">
                        <button id="<?= $cart_id ?>_continueShopping_btn" class="btn btn-lg btn-info continue_shopping"><i class="fa fa-arrow-left"></i>&nbsp;<?= trans($cart_button_1) ?></button>
                        <button id="<?= $cart_id ?>_placeOrder_btn" class="btn btn-lg btn-primary place_order"><i class="fas fa-shopping-cart"></i>&nbsp;<?= trans($cart_button_2) ?></button>
