    ...
    <div class="card card-default">
        ...
        <div class="card-body">
            ...
            <div id="sub_depot" class="row">
                ...
                <div class="col-6">
                    <?php $this->load->view('master/select_field', array("field_id" => "select_executive", "CSS_CLASS" => "select_canteen_user", "label" => "executive", "place_holder" => "Select a executive", "option_record" => $userlist, "option_value" => "id", "option_text" => "name", "selected_value" => getValue('executive', $user_details))); ?>
                </div>
                <div class="col-6">
                    <?php $this->load->view('master/select_field', array("field_id" => "select_supervisor", "CSS_CLASS" => "select_canteen_user", "label" => "supervisor", "place_holder" => "Select a supervisor", "option_record" => $userlist, "option_value" => "id", "option_text" => "name", "selected_value" => getValue('supervisor', $user_details))); ?>
                </div>
