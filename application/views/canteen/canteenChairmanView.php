        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-6">
                    ...
                    $this->load->view('master/select_field', array("field_id" => "outlet_type", "label" => "type", "place_holder" => "Select an outlet", "option_record" => $outlet_type_select_option_array, "option_value" => "id", "option_text" => "entity_type", "selected_value" => getValue('entity_type', $resultArray)));
                    ?>
                </div>
                <div class="col-6">
...
<script src="<?= base_url() ?>assets/js/module/canteen/canteenChairmanDetail.js"></script>