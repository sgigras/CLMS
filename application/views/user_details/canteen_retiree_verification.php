        ...
        <div class="card-body">
            <div class="row">
                <div class="col-5">
                    ...
                    <?php $this->load->view('master/select_field', array("field_id" => "select_canteen", "label" => "canteen", "place_holder" => "Select a canteen", "option_record" => $canteen_data_array, "option_value" => "id", "option_text" => "entity_name", "selected_value" => ''));
                    ?>
                ...
                <div class="col-3">
                    <?php $registration_status_array = array(
                        ...
                        array("status" => "verification_completed", "option_text" => "Verification Completed"),
                    );
...
<script src="<?= base_url() ?>assets/js/module/reports/canteen_retiree_verification.js"></script>