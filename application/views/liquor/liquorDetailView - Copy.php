                ...
                <div class="col-11">
                    <div class="row">
                        <div class="col-4" style='padding-left:10px !important; border-right: 1px solid #34343434;'>
                            <?php $this->load->view('master/upload_image_block_field', array("field_id" => "liquor_image", "name" => "liquor_image", "css_class" => "photostyle", "width" => "300px", "height" => "400px", "image_title" => getValue('image_name', $resultArray), "image_title" => getValue('image_name', $resultArray))) ?>
                        </div>
                        ...
                        <div class="col-6">
                            <div class='row'>
                                <div class='col'>
                                    <?php
                                    $this->load->view('master/select_field', array("field_id" => "liquor_brand", "label" => "liquor_brand", "place_holder" => "Select a liquor brand", "option_record" => $alcohol_brand_record, "option_value" => "id", "option_text" => "alcohol_brand", "selected_value" => getValue('alcohol_type', $resultArray))); ?>
                                </div>
                            </div>
                            ...
                            <div class='row'>
                                <div class='col'>
                                    <?php $this->load->view('master/select_field', array("field_id" => "liquor_type", "label" => "liquor_type", "place_holder" => "Select a liquor type", "option_record" => $alcohol_type_record, "option_value" => "id", "option_text" => "alcohol_type", "selected_value" => getValue('alcohol_type', $resultArray))); ?>
                                </div>
                            </div>
                            <!-- <br> -->
                            <div class='row'>
                            ...
                            <div class='row'>
                                <div class='col'>
                                    <?php
                                    $this->load->view('master/select_field', array("field_id" => "bottle_vol", "label" => "bottle_vol", "place_holder" => "Select a bottle volume", "option_record" => $bottle_volume_record, "option_value" => "id", "option_text" => "bottle_volume", "selected_value" => getValue('bottle_size', $resultArray))); ?>
                                </div>
                            </div>
                            <!-- <br> -->
                            <div class="row">
