-- 45 SP
create
    procedure itbp_clms.SP_ADDITIONAL_SHEETS(IN P_DATA json)
BEGIN
...
create
    procedure itbp_clms.SP_ADD_REMOVE_LIQUOR(IN P_DATA json)
BEGIN
...
create
    procedure itbp_clms.SP_ADD_STOCK(IN P_DATA json)
BEGIN
...
create
    procedure itbp_clms.SP_BEER_CART_CHECKOUT()
BEGIN
...
create
    procedure itbp_clms.SP_CANCEL_EXPIRED_ORDER(IN V_DATA varchar(200))
BEGIN
...
create
    procedure itbp_clms.SP_CART_CHECK_OUT(IN P_DATA json)
BEGIN
    DECLARE V_SWAL_TYPE,V_SWAL_TITLE,V_SWAL_TEXT,V_LIQUOR_DETAILS,V_MODE VARCHAR(500) DEFAULT '';
    DECLARE V_PAGE_MODE,V_ORDER_CODE,V_CART_TYPE VARCHAR(100);
    DECLARE V_CART_DATA JSON;
...
create
    procedure itbp_clms.SP_CART_CHECK_OUT_BACKUP(IN P_DATA json)
BEGIN
...
create
    procedure itbp_clms.SP_CART_CHECK_OUT_BACKU_LATEST(IN P_DATA json)
BEGIN
...
create
    procedure itbp_clms.SP_CART_INSERT_UPDATE_ITEM(IN P_DATA json)
BEGIN
...
create
    procedure itbp_clms.SP_CART_INSERT_UPDATE_ITEM_BACKUP(IN P_DATA json)
BEGIN
...
create
    procedure itbp_clms.SP_CART_ORDER_INSERT_UPDATE(IN P_DATA json)
BEGIN
	DECLARE V_SWAL_TYPE,V_SWAL_TITLE,V_SWAL_TEXT VARCHAR(500) DEFAULT '';
    DECLARE V_PAGE_MODE VARCHAR(100);
    DECLARE V_CART_DATA JSON;
...
create
    procedure itbp_clms.SP_CART_PLACE_ORDER(IN P_DATA json)
BEGIN
...
create
    procedure itbp_clms.SP_CART_PLACE_ORDER_BACKUP(IN P_DATA json)
BEGIN
	DECLARE V_CART_ID,V_USER_ID INT;
    DECLARE V_MODE,V_SWAL_TYPE,V_SWAL_TITLE,V_SWAL_TEXT,V_ORDER_CODE VARCHAR(225);
	DECLARE EXIT HANDLER FOR SQLEXCEPTION
...
create
    procedure itbp_clms.SP_CHECK_DETAILS()
BEGIN
...
create
    procedure itbp_clms.SP_CORRECT_STOCKS()
BEGIN
...
create
    procedure itbp_clms.SP_CORRECT_STOCKS_AVAILABLE()
BEGIN
...
create
    procedure itbp_clms.SP_CREATE_TODAYS_STOCK()
BEGIN
...
create
    procedure itbp_clms.SP_DELIVERY_CART_CHECK_OUT(IN P_DATA json)
BEGIN
...
create
    procedure itbp_clms.SP_DELIVERY_CART_CHECK_OUT_BACKUP(IN P_DATA json)
BEGIN
	DECLARE V_SWAL_TYPE,V_SWAL_TITLE,V_SWAL_TEXT VARCHAR(500) DEFAULT '';
...
create
    procedure itbp_clms.SP_DELIVER_LIQUOR(IN P_ORDER_CODE varchar(50), IN P_USERID int)
BEGIN
...
create
    procedure itbp_clms.SP_DELIVER_LIQUOR_BACKUP(IN P_ORDER_CODE varchar(50))
BEGIN
...
create
    procedure itbp_clms.SP_EDIT_LIQUOR_DETAILS(IN P_DATA json)
BEGIN
        DECLARE V_MODE,V_LIQUOR_TYPE,V_LIQUOR_NAME,V_ENTITY_TYPE,  V_SWAL_TITLE,V_SWAL_MESSAGE,V_SWAL_TYPE VARCHAR(225);
...
create
    procedure itbp_clms.SP_INSERT_CANTEEN_DETAILS(IN P_DATA json)
BEGIN
...
create
    procedure itbp_clms.SP_INSERT_UPDATE_CANTEEN_DETAILS(IN P_DATA json)
BEGIN
...
create
    procedure itbp_clms.SP_INSERT_UPDATE_CANTEEN_DETAILS_BACKUP(IN P_DATA json)
BEGIN
...
create
    procedure itbp_clms.SP_INSERT_UPDATE_HIMVEER_USER_DETAIL(IN V_USERNAME varchar(50),
...
create
    procedure itbp_clms.SP_INSERT_UPDATE_LIQUOR_DETAILS(IN P_DATA json)
BEGIN
...
create
    procedure itbp_clms.SP_INSERT_UPDATE_LIQUOR_MAPPING_DETAILS(IN P_DATA json)
BEGIN
	DECLARE V_MODE,V_LIQUOR_TYPE,V_LIQUOR_NAME,V_ENTITY_TYPE,  V_SWAL_TITLE,V_SWAL_MESSAGE,V_SWAL_TYPE VARCHAR(225);
    DECLARE V_LIQUOR_TYPE_ID,V_ID,V_USER_ID,V_MOQ,V_ML,V_ENTITY_ID,V_STOCK_SALE_ID,V_OPENING_QTY,V_PRE_DISPLAY_AVAILABLE_QUANTITY,V_PRE_PHYSICAL_AVAILABLE_QUANTITY,V_LIQUOR_BALANCE,V_SALE_QTY,V_UNIT_PROFIT,V_LIQUOR_DESCRIPTION_ID,V_QUANTITY_DIFF,V_DISPLAY_AVAILABLE_QUANTITY,V_PHYSICAL_AVAILABLE_QUANTITY,V_AVAILABLE_QUANTITY,V_REORDER_LEVEL INT;
    ...
    START TRANSACTION;
        ...
        IF NOT EXISTS(SELECT id FROM liquor_entity_mapping WHERE entity_id=V_ENTITY_ID AND liquor_description_id=V_LIQUOR_DESCRIPTION_ID AND selling_price=V_SELL_PRICE AND purchase_price=V_PURCHASE_PRICE)THEN
			BEGIN
                ...
                INSERT INTO liquor_entity_mapping(liquor_description_id,liquor_type_id,ml_id,entity_id,entity_type,base_price,selling_price,purchase_price,available_quantity,actual_available_quantity,minimum_order_quantity,created_type,creation_time,reorder_level)
                VALUES(V_LIQUOR_DESCRIPTION_ID,V_LIQUOR_TYPE,V_ML,V_ENTITY_ID,V_ENTITY_TYPE,V_BASE_PRICE,V_SELL_PRICE,V_PURCHASE_PRICE,V_AVAILABLE_QUANTITY,V_AVAILABLE_QUANTITY,V_MOQ,V_USER_ID,NOW(),V_REORDER_LEVEL);
...
create
    procedure itbp_clms.SP_INSERT_UPDATE_PRODUCT_DETAILS(IN P_DATA json)
BEGIN
...
create
    procedure itbp_clms.SP_NEW_AVAILABLE_STOCK(IN P_DATA json)
BEGIN
...
create
    procedure itbp_clms.SP_NEW_CART_CHECK_OUT(IN P_DATA json)
BEGIN
     DECLARE V_SWAL_TYPE,V_SWAL_TITLE,V_SWAL_TEXT,V_LIQUOR_DETAILS,V_MODE VARCHAR(500) DEFAULT '';
    DECLARE V_PAGE_MODE,V_ORDER_CODE,V_CART_TYPE VARCHAR(100);
    DECLARE V_CART_DATA JSON;
...
create
    procedure itbp_clms.SP_NEW_CART_CHECK_OUT_BEER(IN P_DATA json)
BEGIN
    DECLARE V_SWAL_TYPE,V_SWAL_TITLE,V_SWAL_TEXT,V_LIQUOR_DETAILS,V_MODE VARCHAR(500) DEFAULT '';
    DECLARE V_PAGE_MODE,V_ORDER_CODE,V_CART_TYPE VARCHAR(100);
    DECLARE V_CART_DATA JSON;
...
create
    procedure itbp_clms.SP_NEW_CART_CHECK_OUT_EXCESS_QUOTA(IN P_DATA json)
BEGIN
    DECLARE V_SWAL_TYPE,V_SWAL_TITLE,V_SWAL_TEXT,V_LIQUOR_DETAILS,V_MODE VARCHAR(500) DEFAULT '';
    DECLARE V_PAGE_MODE,V_ORDER_CODE,V_CART_TYPE VARCHAR(100);
    DECLARE V_CART_DATA JSON;
...
create
    procedure itbp_clms.SP_NEW_DELIVER_LIQUOR(IN P_ORDER_CODE varchar(50), IN P_USERID int)
BEGIN
    DECLARE V_SWAL_TYPE,V_ENTITY_NAME,V_SWAL_TITLE,V_SWAL_TEXT,V_CART_TYPE,V_LIQUOR_ENTITY_ID,V_LIQUOR_COUNT,V_QUANTITY,V_NEW_QUANTITY,V_CURRENT_AVAILABLE_QUANTITY,V_LIQUOR VARCHAR(500) DEFAULT '';
    DECLARE V_LIQUOR_ENTITY_DETAILS,V_LIQUOR_ENTITY_ID_QUANTITY,V_LIQUOR_DETAILS,V_LIQUOR_NA_LIST  TEXT DEFAULT '';
...
create
    procedure itbp_clms.SP_NEW_USER_CANCEL_ORDER(IN P_DATA json)
BEGIN
...
create
    procedure itbp_clms.SP_ORDER_TO_BREWERY(IN P_DATA json)
BEGIN
...
create
    procedure itbp_clms.SP_REARRANGE_STOCK(IN P_DATE date)
BEGIN
...
create
    procedure itbp_clms.SP_RECEIVED_LIQUOR_DELIVERY(IN P_DATA json)
BEGIN
...
create
    procedure itbp_clms.SP_REGISTER_USER(IN P_DATA json)
BEGIN
...
create
    procedure itbp_clms.SP_SEND_EMAIL(IN P_MODE varchar(255),
...
create
    procedure itbp_clms.SP_SEND_SMS(IN V_USERNAME varchar(255), IN V_PHONENO bigint, IN V_OTP_CODE int)
BEGIN
...
create
    procedure itbp_clms.SP_TEST(IN country char(3), OUT cities int)
BEGIN
...
create
    procedure itbp_clms.SP_UPDATE_CHAIRMAN_CANTEEN_DETAILS(IN P_DATA json)
BEGIN
        DECLARE V_MODE,V_ENTITY_NAME,V_ADDRESS,V_REGISTERED_BY,V_REGISTRATION_TIME, V_SWAL_TITLE,V_SWAL_MESSAGE,V_SWAL_TYPE,V_CHAIRMAN_MAIL_ID,V_SUPERVISOR_MAIL_ID,V_EXECUTIVE_MAIL_ID,V_TABLE_NAME VARCHAR(225);
        DECLARE V_CITY,V_ENTITY_ID,V_ID,V_LAST_UPDATE_RECORD_LOG_ID,V_STATE,V_USER_ID,V_CURRENT_CHAIRMAN,V_CURRENT_SUPERVISOR,V_CURRENT_EXECUTIVE,V_CHAIRMAN,V_SUPERVISOR,V_EXECUTIVE,V_DISTRIBUTING_ENTITY_TYPE,V_AUTHORISED_ENTITY,V_BREWERY_ENTITY_TYPE_ID,V_OUTLET_TYPE INT;
        ...
        START TRANSACTION;
            ...
            UPDATE ci_admin SET entity_id=V_ENTITY_ID,admin_role_id=64 WHERE admin_id IN (V_SUPERVISOR);
            UPDATE ci_admin SET entity_id=V_ENTITY_ID,admin_role_id=66 WHERE admin_id IN (V_EXECUTIVE);
        COMMIT;
     SELECT V_SWAL_TITLE,V_SWAL_MESSAGE,V_SWAL_TYPE;
    END;

create
    procedure itbp_clms.SP_USER_CANCEL_ORDER(IN P_DATA json)
BEGIN
	DECLARE V_ORDER_CODE VARCHAR(100);
    DECLARE V_ORDER_LIQUOR_DETAILS,V_LIQUOR_ENTITY_QUANTITY,V_SWAL_TYPE,V_SWAL_TITLE,V_SWAL_TEXT VARCHAR(500);
    DECLARE V_USERID,V_CART_ID BIGINT;
...
create
    procedure itbp_clms.SP_VERIFY_RETIREE(IN P_DATA json)
BEGIN
