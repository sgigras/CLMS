...
create
    function FN_PREPARE_INSERT_UPDATE_STATEMENT(P_MODE varchar(10), P_TABLE_NAME varchar(55),
                                                                         P_DATA_TYPE_LIST text, P_FIELD_LIST text,
                                                                         P_DATA_LIST text, P_WHERE_FIELD_LIST text,
